 ...
 * Short value
 */
int16_t readShort(std::vector<char> payload, int location, bool is_little) {
    union {
        char c[2];
        int16_t s;
    } u;
 ...
 * Int value
 */
int32_t readInt(std::vector<char> payload, int location, bool is_little) {
    union {
        char c[4];
        int32_t i;
    } u;
 ...
 * Float value
 */
float readFloat(std::vector<char> payload, int location, bool is_little) {
    union {
        char c[4];
        float f;
    } u;
 ...
 * Double value
 */
double readDouble(std::vector<char> payload, int location, bool is_little) {
    union {
        char c[8];
        double d;
    } u;
 ...
 * Location of the payload to start reading
 */
void readPayLoad(std::vector<char> payload, int location, int endian) {
...
int main(int argc, char* argv[]) {
    ...
    std::vector<char> test = {
        0x0a, 0x00, 0x00, 0x08, 0x04, 0x00, 0x6e, 0x61, 0x6d, 0x65, 0x0d, 0x00,
        0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x61, 0x69,
        0x72, 0x0a, 0x06, 0x00, 0x73, 0x74, 0x61, 0x74, 0x65, 0x73, 0x00, 0x03,
        0x07, 0x00, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x01, 0x0a, 0x12,
        0x01, 0x00, 0x0a, 0x00, 0x00, 0x08, 0x04, 0x00, 0x6e, 0x61, 0x6d, 0x65,
        0x0f, 0x00, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a,
        0x73, 0x74, 0x6f, 0x6e, 0x65, 0x0a, 0x06, 0x00, 0x73, 0x74, 0x61, 0x74,
        0x65, 0x73, 0x08, 0x0a, 0x00, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x5f, 0x74,
        0x79, 0x70, 0x65, 0x05, 0x00, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x00, 0x03,
        0x07, 0x00, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x01, 0x0a, 0x12,
        0x01, 0x00};
